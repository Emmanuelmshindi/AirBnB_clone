...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    @classmethod
    def tearDown(self):
        """Remove the temporary json file created for testing"""
        try:
            os.remove("file.json")
        except Exception:
            pass
    ...
    def test_docstrings_in_console(self):
        """Test console.py has at least one docstring"""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Test display of help messages of the HBNBCommand interpreter"""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for exiting the HBNBCommand interpreter"""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for the create command of the HBNBCommand interpreter"""
    @classmethod
    def setUp(self):
        try:
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for the show method of the HBNB command interpreter"""
    ...
    def test_show_no_instance_found_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("BaseModel 1"))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            command = "Basemodel.{}".format(testID)
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for destroy command of the HBNB command interpreter"""
    @classmethod
    def setUp(self):
        try:
            os.rename("file.json", "tmp")
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittest to test the all command of the HBNB command interpreter"""
    @classmethod
    def setUp(self):
        try:
            os.rename("file.json", "tmp")
